...
public class GlobalHandlerException {
    ...
    /**
     * Handles {@link ProjectNotFoundException} when a requested project product ID is not found.
     * <p>
     *      This method logs the error and returns a standardized HTTP response with a 404 Not Found status.
     * </p>
     *
    ...
    public ResponseEntity<Object> handleProjectProductNotFoundException(ProjectNotFoundException exception) {
        /* Sending the error to log */
